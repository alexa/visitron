...
--model_name_or_path srv/results/pretrain/pretrain_masked_lm_1-in-36-viewpoint_ndh_r2r_r4r-multi-gpu-ddp/checkpoints/checkpoint-30000
--output_dir srv/results/viewpoint/ndh-r2r-rxr_pretrain-ndh-r2r-r4r
--add_r2r_data
--add_rxr_data
