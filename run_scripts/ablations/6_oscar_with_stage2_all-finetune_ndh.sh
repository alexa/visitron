...
--model_name_or_path srv/results/pretrain/pretrain-all-ndh_r2r-multi-gpu-ddp/checkpoints/checkpoint-30000
--output_dir srv/results/viewpoint_select/ndh-oscar_stage2_all
