...
eval_iters=""
for (( COUNTER=0; COUNTER<=50000; COUNTER+=500 )); do  # 10 to 40010 gap 500
    eval_iters="$eval_iters $COUNTER"
done

# eval_iters="$eval_iters 30000"

exp_name=srv/results/pretrain/pretrain-masked_lm-ndh_r2r-multi-gpu-ddp
