...
--model_name_or_path srv_2/results/pretrain/pretrain_all_without_objecttags_ndh_r2r-multi-gpu-ddp/checkpoints/checkpoint-30000
--output_dir srv_2/results/viewpoint-2/ndh_r2r-oscar_stage2_all_without_objecttags
--add_r2r_data
