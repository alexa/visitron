...
--model_name_or_path oscar_ndh_results/pretrain_masked_lm_1-in-36-viewpoint/checkpoints/checkpoint-6015/
--output_dir oscar_ndh_results/finetune_viewpoint-selection_lstm-agent_planner-path_sample_interleave-r2r-oscar-6k
--agent att-lstm
--encoder oscar
