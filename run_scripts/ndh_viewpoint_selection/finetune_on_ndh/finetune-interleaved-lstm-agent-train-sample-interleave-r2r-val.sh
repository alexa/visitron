eval_iters=""
for (( COUNTER=8710; COUNTER<=50000; COUNTER+=100 )); do  # 10 to 40010 gap 500
    eval_iters="$eval_iters $COUNTER"
done
exp_name=finetune_interleaved_viewpoint-selection_lstm-agent_planner-path_sample_interleave-r2r
