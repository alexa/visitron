...
--model_name_or_path oscar_ndh_results/pretrain_ndh_r2r_masked_lm_1-in-36-viewpoint/checkpoints/checkpoint-45000/
--output_dir oscar_ndh_results/finetune_interleaved_viewpoint-selection_lstm-agent_planner-path_sample_interleave-r2r-oscar-encoder-45k
--agent att-lstm
--encoder oscar
