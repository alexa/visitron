...
exp_name=finetune_interleaved_viewpoint-selection_lstm-agent_trusted-path_sample_interleave-r2r-oscar-encoder-25k
...
--model_name_or_path oscar_ndh_results-4/$exp_name/checkpoints/
