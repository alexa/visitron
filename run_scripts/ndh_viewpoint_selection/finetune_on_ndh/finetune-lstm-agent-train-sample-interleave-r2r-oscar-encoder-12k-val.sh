...
exp_name=finetune_viewpoint-selection_lstm-agent_planner-path_sample_interleave-r2r-oscar-12k
...
--model_name_or_path oscar_ndh_results-2/$exp_name/checkpoints/
