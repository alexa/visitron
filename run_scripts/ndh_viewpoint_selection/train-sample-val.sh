eval_iters=""
for (( COUNTER=11010; COUNTER<=50000; COUNTER+=500 )); do  # 10 to 40010 gap 500
    eval_iters="$eval_iters $COUNTER"
done
exp_name=viewpoint_selection_v1


arguments="
--img_feat_dir img_features
--img_feature_file ResNet-101-faster-rcnn-genome-pano-worientation.pickle
--candidate_feature_file ResNet-101-faster-rcnn-genome-candidate-worientation.pickle
