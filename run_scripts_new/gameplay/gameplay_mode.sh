...
file="tasks/FINAL_TASK/train_gameplay.py"

arguments="
--img_feat_dir srv/img_features
--img_feature_file ResNet-152-imagenet.tsv
--data_dir srv/task_data/NDH/data
--model_name_or_path srv_2/results/classifier/teacher_force-frozen-try3_2layers_weight5-multi-gpu-ddp/checkpoints/checkpoint-13210/
--saved_speaker_model_file srv_2/results/gameplay/speaker_pretrain-try2-single-gpu/checkpoints/speaker/best_val_unseen
--output_dir srv_2/results/gameplay/agent_speaker-$1
--max_seq_length 512
