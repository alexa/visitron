...
eval_iters=""
for (( COUNTER=25500; COUNTER<=229000; COUNTER+=500 )); do  # 10 to 40010 gap 500
    eval_iters="$eval_iters $COUNTER"
done

# eval_iters="$eval_iters 227279"

exp_name=pretrain_masked_lm_1-in-36-viewpoint_ndh_r4r-multi-gpu-ddp-rerun
