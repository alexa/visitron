...
eval_iters=""
for (( COUNTER=19910; COUNTER<=50000; COUNTER+=100 )); do  # 10 to 40010 gap 500
    eval_iters="$eval_iters $COUNTER"
done

# eval_iters="$eval_iters 10000"

exp_name=srv_2/results/viewpoint-2/ndh_rxr-pretrain_ndh_r2r-trusted
...
--output_dir $exp_name-val-planner
