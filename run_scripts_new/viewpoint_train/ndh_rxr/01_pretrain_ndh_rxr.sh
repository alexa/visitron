...
--model_name_or_path srv_2/results/pretrain/pretrain_masked_lm_1-in-36-viewpoint_ndh_rxr-multi-gpu-ddp/checkpoints/checkpoint-30000
--output_dir srv_2/results/viewpoint-2/ndh_rxr-pretrain_ndh_rxr
--add_rxr_data
