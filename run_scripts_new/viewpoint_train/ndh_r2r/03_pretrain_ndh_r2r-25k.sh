...
--model_name_or_path srv/results/pretrain/pretrain_masked_lm_1-in-36-viewpoint_ndh_r2r-TAR-front-multi-gpu-ddp/checkpoints/checkpoint-25000
--output_dir srv/results/viewpoint/ndh_r2r-tar_front_pretrain-ndh-r2r-25k
--add_r2r_data
