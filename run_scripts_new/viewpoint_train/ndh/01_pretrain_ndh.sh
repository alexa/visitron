...
--model_name_or_path srv/results/pretrain/pretrain_masked_lm_1-in-36-viewpoint_ndh-DDP/checkpoints/checkpoint-24500
--output_dir srv/results/viewpoint-2/ndh_pretrain-ndh
