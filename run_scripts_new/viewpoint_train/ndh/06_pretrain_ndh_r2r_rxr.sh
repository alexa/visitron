...
--model_name_or_path srv/results/pretrain/pretrain_masked_lm_1-in-36-viewpoint_ndh_r2r_rxr-multi-gpu-ddp/checkpoints/checkpoint-20000
--output_dir srv/results/viewpoint-2/ndh_pretrain-ndh-r2r-rxr
