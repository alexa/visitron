...
--model_name_or_path srv/results/pretrain/pretrain_masked_lm_1-in-36-viewpoint_ndh_r4r-multi-gpu-ddp-rerun/checkpoints/checkpoint-35500
--output_dir srv/results/viewpoint-2/ndh_pretrain-ndh-r4r
