...
--model_name_or_path srv_2/results/pretrain/pretrain_masked_lm_ndh_r2r-multi-gpu-ddp/checkpoints/checkpoint-30000
--output_dir srv_2/results/viewpoint-2/ndh-oscar_stage2_lm
