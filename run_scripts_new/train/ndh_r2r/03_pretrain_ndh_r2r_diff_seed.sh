...
--model_name_or_path srv/results/pretrain/pretrain_masked_lm_1-in-36-viewpoint_ndh_r2r-TAR-front-multi-gpu-ddp/checkpoints/checkpoint-30000
--output_dir srv/results/viewpoint/ndh_r2r-pretrain-ndh-r2r-diff-seed
--add_r2r_data
