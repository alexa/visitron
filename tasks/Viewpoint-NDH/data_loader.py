...
class VLNDataLoader(DataLoader):
    def __init__(
        ...
        **kwargs,
        ...
        self.candidate_features = candidate_feature_store
    ...
    def make_candidate(self, scanId, viewpointId, viewId):
        ...
        feature = self.candidate_features[f"{scanId}_{viewpointId}"]
        ...
        if long_id not in self.buffered_state_dict:
                ...
                for j, loc in enumerate(state.navigableLocations[1:]):
                    ...
                    if (
                        ...
                        adj_dict[loc.viewpointId] = {
                            ...
                            "distance": distance,
                            "idx": j + 1,
                            # "feature": np.concatenate((visual_feat, angle_feat), -1),  # TODO: add this angle feature
                            "feature": visual_feat,
                        }
            ...
            for c in candidate:
                ...
                # c_new["feature"] = np.concatenate((visual_feat, angle_feat), -1) # TODO: add this angle feature
    ...
    def _get_obs(self):
        ...
        for i, (feature, state) in enumerate(self.env.getStates()):
            ...
            candidate = self.make_candidate(
                state.scanId, state.location.viewpointId, state.viewIndex,
            )

            region_labels = self.region_labels[
                f"{state.scanId}_{state.location.viewpointId}"
            ]
